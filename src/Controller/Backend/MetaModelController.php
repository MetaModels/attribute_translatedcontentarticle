...
namespace MetaModels\AttributeTranslatedContentArticleBundle\Controller\Backend;
 ...
 *
 * @package MetaModels\AttributeTranslatedContentArticleBundle\Controller\Backend
 *
...
class MetaModelController
{
    ...
    public function __invoke(
        ...
        $this->fixDca($action, $tableName, $attribute, $lang, $itemId, $connection, $session, $security);
    ...
    private function fixDca(
        ...
        $GLOBALS['TL_DCA']['tl_content']['list']['sorting']['filter'][]                     = ['mm_lang=?', $lang];
    }
    ...
    private function slotSetterCallback(
        ...
        return function (string $insertId) use ($parent, $itemId, $attribute, $lang, $connection): void {
            $this->updateContentElement($connection, $itemId, $parent, $attribute, $lang, $insertId);
        };
    }
